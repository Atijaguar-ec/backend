...
SET @ddl :=
  IF(@farmColumnExists > 0,
    ...
    IF(@wrongNameExists > 0,
      'ALTER TABLE UserCustomer CHANGE COLUMN farm_max_production_quantity farm_maxProductionQuantity DECIMAL(19,2) NULL COMMENT ''Maximum production quantity in quintals (qq)''',
