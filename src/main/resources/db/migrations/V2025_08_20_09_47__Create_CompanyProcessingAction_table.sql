...
CREATE INDEX idx_company_processing_action_company_enabled_order 
    ON company_processing_action (company_id, enabled, order_override);

-- Index for processing_action_id lookups
CREATE INDEX idx_company_processing_action_processing_action 
    ON company_processing_action (processing_action_id);
