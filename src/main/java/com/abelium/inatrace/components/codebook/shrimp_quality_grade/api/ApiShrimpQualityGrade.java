...
/**
 * API DTO for ShrimpQualityGrade catalog.
 */
@Validated
public class ApiShrimpQualityGrade extends ApiCodebookBaseEntity {

    @Schema(description = "Unique code (A, B, C)")
    private String code;
    ...
    private List<ApiShrimpQualityGradeTranslation> translations;
    ...
    public List<ApiShrimpQualityGradeTranslation> getTranslations() {
        return translations;
    }

    public void setTranslations(List<ApiShrimpQualityGradeTranslation> translations) {
